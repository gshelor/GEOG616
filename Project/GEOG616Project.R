...
## testing out elevation grab
## need to figure out crs issue before elevation grab will work
snoteldata_az <- snoteldata_dropNA |>
  filter(state == "AZ")
snoteldata_az_sf <- st_as_sf(snoteldata_az, coords = c("longitude", "latitude"))
# elevation <- get_tiles(
#   snoteldata_az_sf,
