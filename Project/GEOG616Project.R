...
library(pacman)
pacman::p_load(snotelr, sf, terra, tidyterra, tidyverse, here, crsuggest, terrainr, rstac)
...
ecoregions_vect <- vect(ecoregions_usb_sf)
...
##### testing elevation grab #####
snoteldata_elevationtest_sf <- snoteldata_conus_grp_sf |>
  filter(site_id == 982 | site_id == 1045 | site_id == 354 | site_id == 920)

## elevation data
# elevation <- get_tiles(
#   snoteldata_elevationtest_sf,
